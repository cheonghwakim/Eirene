...
class FeatureExtractor:
  ...
  def _build_detection_model(self):
      ...
      cfg.merge_from_file('C:\Project2\skeleton-project\speak_image\IC\model_data/detectron_model.yaml')
      cfg.freeze()
...
if __name__ == '__main__':
  pass
  ins = Caption_Model()  # instance 생성
  img = cv2.imread('lena.jpg', cv2.IMREAD_COLOR)
  result = ins.inference('lena.jpg')
