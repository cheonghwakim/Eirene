...
class TTS_Model:
    ...
    def __init__(self):
        ...
        with open('../speak_image/TTS/config.yaml') as f:
    ...
    def load_model(self):
        ...
        # pass
        checkpoint_path = '../speak_image/TTS/pretrained/tts_warmstart'
        ...
        #waveglow model load
        waveglow_path = "../speak_image/TTS/pretrained/waveglow.pt"
